# Cave Dweller (NeoForge Port — 1.21.10)

Self-contained NeoForge build of Cave Dweller Evolved for **Minecraft 1.21.10**.
...
- Minecraft **1.21.10**
- NeoForge **21.10.64+**
- GeckoLib **5.3-alpha-1+** (NeoForge, built against 5.3-alpha-3)
- Java **21**
...
```bash
./gradlew build
# Output: build/libs/cave_dweller-1.6.4-neoforge-1.21.10.jar
```
